...
<head>
    ...
    <title>Schul Auswahl</title> <!-- Änderungen -->
    ...
    <div class="row">
        <form class="col-lg-6">
            <div class="input-group pt-2">
                <h1>Auswahl der Schule:</h1>
            </div>
        </form>
        <form class="col-lg-6">
            <div class="input-group mt-3 mb-3">
                <div class="input-group-prepend">
                    <label class="input-group-text" for="inputGroupSelect01">Suche</label>
                </div>
                <select class="custom-select form-control" id="inputGroupSelect01">
                    <option selected></option>
                    <option value="1">Schule 1</option>
                    <option value="2">Schule 2</option>
                    <option value="3">Schule 3</option>
                </select>
            </div>
        </form>
    </div>
